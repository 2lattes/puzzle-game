            ...
            return (
              <li key={puzzle.id}>
                <article
                  ...
                  className={`group relative aspect-square overflow-hidden rounded-[2rem] bg-white shadow-[0_8px_20px_rgba(0,0,0,0.03)] ring-1 ring-slate-900/5 transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] hover:shadow-[0_20px_40px_rgba(168,101,93,0.15)] hover:ring-puzzle-primary/20 hover:-translate-y-2 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-puzzle-primary ${
                ...
                >
                  <CardImage
                    ...
                    alt={puzzle.title}
                    className="h-full w-full object-cover transition-transform duration-[1.5s] ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:scale-[1.08]"
